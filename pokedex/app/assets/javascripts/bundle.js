...
var _api_util = __webpack_require__(20);
...
var _pokemon_actions = __webpack_require__(19);
...
*/
var aa=__webpack_require__(2),m=__webpack_require__(13),A=__webpack_require__(3),B=__webpack_require__(1),ca=__webpack_require__(14),da=__webpack_require__(15),ea=__webpack_require__(16),ha=__webpack_require__(17),ia=__webpack_require__(18),C=__webpack_require__(5);
...
var pokemonReducer = function pokemonReducer() {
  ...
  switch (action.type) {
    case _pokemon_actions.RECEIVE_ALL_POKEMON:
      var pokeIndices = Object.keys(action.pokemon);
      pokeIndices.forEach(function (pokeId) {
        newState[pokeId] = action.pokemon[pokeId];
      });
      return newState;
    default:
      return state;
...
var selectAllPokemon = exports.selectAllPokemon = function selectAllPokemon(state) {
  return Object.keys(state.entities.pokemon).map(function (el) {
    return state.entities.pokemon[el];
  });
};
...
var _pokemon_index_container = __webpack_require__(79);
...
var _pokemon_index = __webpack_require__(80);
